...
colnames(mthNominalDollarRetDataForCorrgram) <- c("Date","Aus","Jpn","Chn","Can","Sui","USA","UK","HK","Fra","Ger","Kor","Bra","Ire","Twn","Ind","Ned","Rus","SA")
mthNominalDollarRetDataForCorrgram <- mthNominalDollarRetDataForCorrgram[,-1]
